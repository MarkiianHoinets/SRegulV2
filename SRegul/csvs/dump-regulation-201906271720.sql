...
INSERT INTO `appels` VALUES (3000000,'+41227484950',-1,'SOS Médecins','toto ','43','Rue Louis-Favre','SOS Médecins','1201','Genève','Suisse ','','','','','','F','1970-01-01','PRIVE-PARTICULIER','A29','','',0,-1,0,'');
...
INSERT INTO `appelsencours` VALUES (3000000,'+41227484950',-1,'SOS Médecins','toto ','43','Rue Louis-Favre','SOS Médecins','1201','Genève','Suisse ','','','','','','F','1970-01-01','PRIVE-PARTICULIER','TEST INFORMATIQUE','','',0,-1);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Médecin en garde : se rempli ou se vide en fonction des médecins en garde.\r\nc''est une table temporaire de Tvl.\r\nOn y stocke également le status du médecin: Visite, en pause, Disponible\r\nainsi que le nombre de visite faite durant sa garde';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='Table du mouchard';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `param_divers` (
  `CodeDispatcheur` varchar(6) DEFAULT NULL,
...
INSERT INTO `param_divers` VALUES ('',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='Table de travail, permettant de savoir où en est le médecin dans la visite: Attente d''attribution, Attribuée, Acquitée, debut de visite, terminée\r\n(A, AT, A, V, T)\r\nPour chaque changement, écrire une ligne dans SuiviAppel, \r\nQuand la visite est terminée, l''enregistrement est supprimé.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `status_visite` VALUES (1,3000000,-1,'A','2019-06-13 12:51:49');
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='C''est l''historique de l''appel\r\nValeurs de Type_Operation : Création, Attribution, Reprise, Annulation,  Acquitement, Début de visite, Terminée  ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `suiviappel` VALUES (5,3000000,'Création',-1,'1401','2019-06-13 12:51:49');
...
-- Dump completed on 2019-06-27 17:20:05
